...
int main()
{
    ...
    while (true)
    {
            ...
            switch(event)
            {
                ...
                cout<<"New packet arrived to be sent to Phsical Layer"<<endl;
                ...
                cout<<"Frame arrived  ";
                cout<< "Type: Acknowlage Frame    sq number =  " << r.ack<<endl;
                ...
                case cksum_err:
                cout<<"CheckSum Error Occured"<<endl;
                  ...
                  for(int i=0;i<MAX_SEQ;i++)
                    {
                            ...
                            {
                                x.count[i]++;
                                if (x.count[i]==10&&timeout_flag==0)
                                {
                                    timeout_flag=1;
...
void Connect_Master(void){
    ...
    cout<<"Receiver has connected"<<endl;
}
